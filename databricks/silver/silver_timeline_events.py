...
from pyspark.sql.functions import col, explode, floor, from_json, posexplode, row_number
...
window_dedup = Window.partitionBy("match_id", "timestamp_ms", "event_index").orderBy(col("extraction_date").desc())
