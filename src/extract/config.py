...
CBLOL_PLAYERS = [
    ...
    {"team": "LOUD", "role": "mid",     "game_name": "Envy",     "tag_line": "BR1"},
    {"team": "LOUD", "role": "adc",     "game_name": "Bull",     "tag_line": "KR1"},
    {"team": "LOUD", "role": "support", "game_name": "RedBert",  "tag_line": "BR1"},

    # paiN Gaming
    {"team": "paiN Gaming", "role": "top",     "game_name": "Robo",    "tag_line": "BR1"},
    {"team": "paiN Gaming", "role": "jungle",  "game_name": "Samkz",   "tag_line": "BR1"},
    {"team": "paiN Gaming", "role": "mid",     "game_name": "Keine",   "tag_line": "KR1"},
    {"team": "paiN Gaming", "role": "adc",     "game_name": "Trigger", "tag_line": "KR1"},
    {"team": "paiN Gaming", "role": "support", "game_name": "Kuri",    "tag_line": "KR1"},

    # RED Canids
    {"team": "RED Canids", "role": "top",     "game_name": "fNb",       "tag_line": "BR1"},
    {"team": "RED Canids", "role": "top",     "game_name": "zynts",     "tag_line": "BR1"},
    {"team": "RED Canids", "role": "jungle",  "game_name": "Curse",     "tag_line": "BR1"},
    {"team": "RED Canids", "role": "jungle",  "game_name": "STEPZ",     "tag_line": "LAS"},
    {"team": "RED Canids", "role": "mid",     "game_name": "Kaze",      "tag_line": "LAS"},
    {"team": "RED Canids", "role": "adc",     "game_name": "Morttheus", "tag_line": "BR1"},
    {"team": "RED Canids", "role": "adc",     "game_name": "Rabelo",    "tag_line": "BR1"},
    {"team": "RED Canids", "role": "support", "game_name": "frosty",    "tag_line": "BR1"},

    # Vivo Keyd Stars
    {"team": "Keyd Stars", "role": "top",     "game_name": "Wizer",   "tag_line": "KR1"},
    {"team": "Keyd Stars", "role": "jungle",  "game_name": "Disamis", "tag_line": "BR1"},
    {"team": "Keyd Stars", "role": "mid",     "game_name": "Mireu",   "tag_line": "KR1"},
    {"team": "Keyd Stars", "role": "adc",     "game_name": "Ceo",     "tag_line": "LAS"},
    ...
    {"team": "Fluxo W7M", "role": "mid",     "game_name": "Cody",     "tag_line": "LAS"},
    {"team": "Fluxo W7M", "role": "adc",     "game_name": "BAO",      "tag_line": "KR1"},
    {"team": "Fluxo W7M", "role": "support", "game_name": "Momochi",  "tag_line": "BR1"},
    ...
    {"team": "Leviatan", "role": "adc",     "game_name": "Snaker", "tag_line": "LAS"},
    {"team": "Leviatan", "role": "support", "game_name": "TopLop", "tag_line": "LAS"},

    # LOS
    {"team": "LOS", "role": "top",     "game_name": "ZEST",      "tag_line": "KR1"},
    {"team": "LOS", "role": "jungle",  "game_name": "Drakehero", "tag_line": "BR1"},
    {"team": "LOS", "role": "mid",     "game_name": "Feisty",    "tag_line": "KR1"},
    {"team": "LOS", "role": "adc",     "game_name": "Duduhh",    "tag_line": "BR1"},
    {"team": "LOS", "role": "support", "game_name": "Ackerman",  "tag_line": "LAS"},
]
